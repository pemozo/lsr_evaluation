...
from CVRPTrainerPartition import CVRPPartitionTrainer as Trainer
...
trainer_params = {
    ...
    'model_load': {
        ...
        't_epoch': 230,  # epoch version of pre-trained conquering model to laod.
        'p_enable': False,  # enable loading pre-trained dividing model
        'p_path': './',  # directory path of pre-trained dividing model.
        'p_epoch': 230,  # epoch version of pre-trained dividing model to laod.
    },
    'validation_test_episodes': 16, # number of data for validation
    'validation_test_batch_size': 2, # batch size of validation
    'validation_aug_factor': 16, # \alpha in paper for validation
}
