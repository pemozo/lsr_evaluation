...
from KPTrainerPartition import KPTrainerPartition as Trainer
...
trainer_params = {
    ...
    'data_load_1000': 'BQ_test_kp1000_nums128_c100_uniform.pt',
    'data_load_500': 'BQ_test_kp500_nums128_c50_uniform.pt',
    'epochs': 120,
    'train_episodes': 1000,
    'train_batch_size': 1,
    'logging': {
    ...
    'model_load': {
        ...
        't_epoch': 120,  # epoch version of pre-trained conquering model to laod.
        'p_enable': False,  # enable loading pre-trained dividing model
        'p_path': './',  # directory path of pre-trained dividing model.
        'p_epoch': 120,  # epoch version of pre-trained dividing model to laod.
    },
