...
from MTSPTrainerPartition import MTSPTrainerPartition as Trainer
...
trainer_params = {
    ...
    'data_load_500': 'mtsp500_test_seed3333.pkl',
    'data_load_1000': 'mtsp1000_test_seed3333.pkl',
    'epochs': 200,
    'train_episodes': 1000,
    'train_batch_size': 1,
    'logging': {
    ...
    'model_load': {
        ...
        't_epoch': 199,  # epoch version of pre-trained conquering model to laod.
        'p_enable': False,  # enable loading pre-trained dividing model
        'p_path': './',  # directory path of pre-trained dividing model.
        'p_epoch': 199,  # epoch version of pre-trained dividing model to laod.
    },
}
